...
First, let’s explore how fonts make it onto web pages. One of the most common ways to load web fonts on a page is to include a CSS `@font-face` style with a `src` attribute for a font file. Since there are many different font formats, it’s common to include multiple font files, each with different formats in the CSS rule.  
<img src="/assets/wp-content/uploads/2017/07/css-example.png" alt="" width="575" height="171" class="alignnone size-full wp-image-219"  /> 
...
<img src="/assets/wp-content/uploads/2017/07/fout_foit.png.jpg" alt="" width="779" height="441" class="alignnone size-full wp-image-204"  /> 
...
<img src="/assets/wp-content/uploads/2017/07/fontstacks-1.jpg" alt="" width="1595" height="215" class="alignnone size-full wp-image-205"  /> 
...
<img src="/assets/wp-content/uploads/2017/07/graphik-webfont.png" alt="" width="983" height="83" class="alignnone size-full wp-image-206" /> 
...
<img src="/assets/wp-content/uploads/2017/07/fontface_css.jpg" alt="" width="921" height="377" class="alignnone size-full wp-image-207" /> 
...
<img src="/assets/wp-content/uploads/2017/07/browser-fallback.png" alt="" width="453" height="261" class="alignnone size-full wp-image-208" /> 
...
<img src="/assets/wp-content/uploads/2017/07/css-font-rendering.png.jpg" alt="" width="1335" height="447" class="alignnone size-full wp-image-209" /> 
...
<img src="/assets/wp-content/uploads/2017/07/wpt_screenshot.jpg" alt="" width="957" height="517" class="alignnone size-full wp-image-210" /> 
...
<head>
  ...
  <head>
    ...
    <ol>
      ...
      <li>
        If prompted to rerun the script, then do it a second time. This is to ensure that all scripts we attempted to request a second time are parsed.<br /> <img src="/assets/wp-content/uploads/2017/07/paste-the-following-javascript-code.jpg" alt="" width="1053" height="109" class="alignnone size-full wp-image-214"  />
      </li>
      <li>
        Once the script is done executing, you should see a table like the one below. TransferSize will only be included if allowed.<br /> <img src="/assets/wp-content/uploads/2017/07/once-script-is-done-executing.jpg" alt="" width="1057" height="297" class="alignnone size-full wp-image-215"  />
      </li>
      <li>
