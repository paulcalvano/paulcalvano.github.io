...
First, let’s explore how fonts make it onto web pages. One of the most common ways to load web fonts on a page is to include a CSS `@font-face` style with a `src` attribute for a font file. Since there are many different font formats, it’s common to include multiple font files, each with different formats in the CSS rule.  
<img src="/assets/wp-content/uploads/2017/07/css-example.png" alt="" width="575" height="171" class="alignnone size-full wp-image-219" srcset="http://paulcalvano.com/wp-content/uploads/2017/07/css-example.png 575w, http://paulcalvano.com/wp-content/uploads/2017/07/css-example-300x89.png 300w" sizes="(max-width: 575px) 100vw, 575px" /> 
...
<img src="/assets/wp-content/uploads/2017/07/browser-fallback.png" alt="" width="453" height="261" class="alignnone size-full wp-image-208" srcset="http://paulcalvano.com/wp-content/uploads/2017/07/browser-fallback.png 453w, http://paulcalvano.com/wp-content/uploads/2017/07/browser-fallback-300x173.png 300w" sizes="(max-width: 453px) 100vw, 453px" /> 
